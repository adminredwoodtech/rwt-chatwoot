...
const adminFeaturesEnabled = isAdminFeaturesEnabled();
...
export default {
  routes: [
    ...
    ...agentBot.routes,
    ...attributes.routes,
    ...(adminFeaturesEnabled ? automation.routes : []),
    ...auditlogs.routes,
    ...billing.routes,
    ...(adminFeaturesEnabled ? canned.routes : []),
    ...inbox.routes,
    ...integrations.routes,
    ...labels.routes,
    ...macros.routes,
    ...(adminFeaturesEnabled ? reports.routes : []),
    ...sla.routes,
    ...teams.routes,
    ...customRoles.routes,
    ...profile.routes,

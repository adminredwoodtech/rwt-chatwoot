...
const menuItems = computed(() => {
  return [
    ...
    //   ],
    // },
    // HAPPSEA: Settings hidden for MVP - managed by admin only
    // {
    //   name: 'Settings',
    ...
    //     },
    //     // HAPPSEA: Automation hidden for MVP - using Claude AI instead
    //     // {
    ...
    //     },
    //     // HAPPSEA: Canned Responses hidden for MVP - AI generates responses
    //     // {
